          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log("%%%%%", _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"]);
                console.log(_server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].options.address);
                _context.next = 5;
                return _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].bounty.call(function (error, response) {
                  if (error) {
                    console.log(error);
                  } else {
...
//# sourceMappingURL=chat.js.c8e4ca35b42e13a4a9c8.hot-update.js.map