...
function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function messageSender(event) {
      //event.target.value;
      if (bountyPaid === true) {
        var localAccount = web3__WEBPACK_IMPORTED_MODULE_24___default.a.eth.accounts[0];
        console.log(localAccount);

        var _msg;

        if (localAccount === manager) {
          var _msg = "0" + event.target.value;
        } else {
          var _msg = "1" + event.target.value;
        }

        _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].methods.sendMessage(_msg).call(function (err, res) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.stateSync();
                _context2.next = 3;
                return _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].newMessage().watch(function (error, response) {
                  if (!error) {
                    _this3.stateSync();
                  }
                });
...
//# sourceMappingURL=chat.js.204ef532dd548053334b.hot-update.js.map