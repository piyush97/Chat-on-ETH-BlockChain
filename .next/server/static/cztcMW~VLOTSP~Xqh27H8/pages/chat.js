...
var modal_ = __webpack_require__(15);
var modal_default = /*#__PURE__*/__webpack_require__.n(modal_);

// EXTERNAL MODULE: external "antd/lib/drawer/style/css"
var style_css_ = __webpack_require__(24);

// EXTERNAL MODULE: external "antd/lib/drawer"
var drawer_ = __webpack_require__(16);
...
var row_style_css_ = __webpack_require__(7);
...
var col_style_css_ = __webpack_require__(8);

// EXTERNAL MODULE: external "antd/lib/col"
var col_ = __webpack_require__(1);
var col_default = /*#__PURE__*/__webpack_require__.n(col_);

// EXTERNAL MODULE: external "antd/lib/breadcrumb/style/css"
var breadcrumb_style_css_ = __webpack_require__(25);

// EXTERNAL MODULE: external "antd/lib/breadcrumb"
var breadcrumb_ = __webpack_require__(17);
var breadcrumb_default = /*#__PURE__*/__webpack_require__.n(breadcrumb_);

// EXTERNAL MODULE: external "antd/lib/icon/style/css"
var icon_style_css_ = __webpack_require__(26);
...
var menu_style_css_ = __webpack_require__(27);

// EXTERNAL MODULE: external "antd/lib/menu"
var menu_ = __webpack_require__(4);
var menu_default = /*#__PURE__*/__webpack_require__.n(menu_);

// EXTERNAL MODULE: external "antd/lib/layout/style/css"
var layout_style_css_ = __webpack_require__(28);

// EXTERNAL MODULE: external "antd/lib/layout"
var layout_ = __webpack_require__(10);
...
var input_ = __webpack_require__(3);
...
var external_web3_ = __webpack_require__(14);
var external_web3_default = /*#__PURE__*/__webpack_require__.n(external_web3_);

// CONCATENATED MODULE: ./server/web3.js

var web3;

if (typeof window !== 'undefined' && typeof window.web3 !== 'undefined') {
  // We are in the browser and metamask is running.
  web3 = new external_web3_default.a(window.web3.currentProvider);
} else {
  // We are on the server *OR* the user is not running metamask
  var provider = new external_web3_default.a.providers.HttpProvider('https://rinkeby.infura.io/orDImgKRzwNrVCDrAk5Q');
  web3 = new external_web3_default.a(provider);
}

/* harmony default export */ var server_web3 = (web3);
// EXTERNAL MODULE: ./server/build/Chat.json
var build_Chat = __webpack_require__(18);

// CONCATENATED MODULE: ./server/chat.js


console.log(server_web3);
var instance = new server_web3.eth.Contract(JSON.parse(build_Chat.interface), '0x106034043d73AD3C02bA0b47eA15E18A7ba3E765');
instance.methods.bounty().call().then(console.log);
/* harmony default export */ var chat = (instance);
// CONCATENATED MODULE: ./pages/chat.jsx
...
var SubMenu = menu_default.a.SubMenu; // Dummy data for messages
  ...
  _createClass(Chat, [{
    ...
    value: function messageSender(event) {
      ...
      if (this.state.BountyPaid == true) {
        var localAccount = server_web3.eth.accounts[0];
        ...
        chat.methods.sendMessage(_msg).send({
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return chat.methods.bounty().call(function (error, response) {
                  if (error) {
                    console.log("error", error);
                  } else {
                    // console.log('response',response);
                    _this2.setState({
                      bountySetValue: server_web3.utils.fromWei(response, "ether")
                    });
                  }
                });
              ...
              case 2:
                _context.next = 4;
                return server_web3.eth.getAccounts();
              ...
              case 4:
                ...
                _context.next = 8;
                return chat.methods.manager().call(function (error, response) {
                  if (error) {
              ...
              case 8:
                _context.next = 10;
                return chat.methods.bountyPaid().call(function (error, response) {
                  if (error) {
              ...
              case 10:
                _context.next = 12;
                return chat.methods.getMessages().call(function (error, response) {
                  if (error) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return chat.events.newMessage({}, function (error, data) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(layout_default.a, {
        ...
        key: "1"
      }, "Piyush"), external_react_default.a.createElement(menu_default.a.Item, {
        key: "2"
      }, " ", external_react_default.a.createElement(link_default.a, {
        href: "/profile"
      }, external_react_default.a.createElement("div", null, "Aditya"))), external_react_default.a.createElement(menu_default.a.Item, {
        key: "3"
      }, "Hemant")), external_react_default.a.createElement(SubMenu, {
        key: "sub2",
        title: external_react_default.a.createElement("span", null, external_react_default.a.createElement(icon_default.a, {
          type: "team"
        ...
        key: "6"
      }, "Team Blume"), external_react_default.a.createElement(menu_default.a.Item, {
        key: "8"
      }, "Team Hello")), external_react_default.a.createElement(menu_default.a.Item, {
        key: "9"
      }, external_react_default.a.createElement(icon_default.a, {
        type: "file"
      }), external_react_default.a.createElement("span", null, "File")), external_react_default.a.createElement(menu_default.a.Item, {
        key: "10",
        onClick: this.showDrawer
      }, external_react_default.a.createElement(icon_default.a, {
        type: "setting",
        theme: "outlined"
      }), external_react_default.a.createElement("span", null, "Settings")), external_react_default.a.createElement(menu_default.a.Item, {
        key: "11"
      }, external_react_default.a.createElement(link_default.a, {
        href: "/"
      }, external_react_default.a.createElement("div", null, external_react_default.a.createElement(icon_default.a, {
        type: "poweroff",
        theme: "outlined"
      }), external_react_default.a.createElement("span", null, "Log Out")))))), external_react_default.a.createElement(layout_default.a, null, external_react_default.a.createElement(Header, {
        style: {
          background: "#fff",
          padding: 0
        }
        ...
        if (message.indexOf("1")) {
          return external_react_default.a.createElement("div", null, external_react_default.a.createElement(row_default.a, null, external_react_default.a.createElement(col_default.a, {
            xs: {
              span: 18
            },
            lg: {
          ...
          }, "Hemant ", external_react_default.a.createElement("br", null)), " ", message.slice(1, message.length)))), external_react_default.a.createElement("br", null));
        } else {
          {
            return external_react_default.a.createElement("div", null, external_react_default.a.createElement(row_default.a, null, external_react_default.a.createElement(col_default.a, {
              xs: {
            ...
            }, "Aditya", external_react_default.a.createElement("br", null)), " ", message.slice(1, message.length)))), external_react_default.a.createElement("br", null));
          }
        }
      ...
      }, "Send"))), external_react_default.a.createElement(Footer, {
        style: {
          textAlign: "center"
        }
      }, external_react_default.a.createElement("b", null, "Created by Team blume"))), external_react_default.a.createElement(drawer_default.a, {
        title: "User Settings",
        placement: "right",
        closable: true,
      ...
      }, "Set Bounty"), external_react_default.a.createElement("p", {
        type: "primary"
      }, "Set Messaging limit"), external_react_default.a.createElement("p", {
        type: "primary"
      }, "Control Privacy")), external_react_default.a.createElement(modal_default.a, {
        title: "Set Bounty",
        style: {
          top: 20
        },
...
/* harmony default export */ var pages_chat = __webpack_exports__["default"] = (chat_Chat);
