...
/* harmony import */ var web3__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! web3 */ "./node_modules/web3/src/index.js");
/* harmony import */ var web3__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(web3__WEBPACK_IMPORTED_MODULE_24__);
...
function (_React$Component) {
  ...
  _createClass(Chat, [{
    key: "messageSender",
    value: function () {
      var _messageSender = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_14___default.a.mark(function _callee(event) {
        var localAccount, _msg;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                localAccount = web3__WEBPACK_IMPORTED_MODULE_24___default.a.eth.accounts[0];
                console.log(localAccount);

                if (localAccount === manager) {
                  _msg = "0" + event.target.value;
                } else {
                  _msg = "1" + event.target.value;
                }

                _context.next = 6;
                return _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].methods.sendMessage(_msg).call(function (err, res) {
                  if (err) console.log("message not sent", err);else console.log("message sent successfully", res);
                });
      ...
      return function messageSender(_x) {
        return _messageSender.apply(this, arguments);
      };
    }()
  }, {
    key: "setModalVisible",
              ...
              case 0:
                ...
                return _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].methods.bounty().call(function (error, response) {
                  if (error) {
                    ...
                    _this2.setState({
                      bountySetValue: web3__WEBPACK_IMPORTED_MODULE_24___default.a.utils.fromWei(response, "ether")
                    });
                  }
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                //  bountyPaid
                this.stateSync();
                _server_chat__WEBPACK_IMPORTED_MODULE_23__["default"].newMessage().watch(function (error, response) {
                  if (!error) {
                    _this3.stateSync();
                  }
                });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_21___default.a.createElement(antd_lib_layout__WEBPACK_IMPORTED_MODULE_18___default.a, {
        ...
        __self: this
      }, this.state.MessageArray.forEach(function (element) {
...
//# sourceMappingURL=chat.js.481c9e98d61927cba76e.hot-update.js.map